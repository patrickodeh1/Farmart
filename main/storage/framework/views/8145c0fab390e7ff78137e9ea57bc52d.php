                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a
                                                        ...
                                                        data-bs-original-title="<?php echo e(__('Edit mapping')); ?>"
                                                        href="#"
                                                        onclick="setMappingData(<?php echo e($mapping->id); ?>, <?php echo e($mapping->product_id); ?>, '<?php echo e($mapping->rezgo_uid); ?>', '<?php echo e($mapping->rezgo_title); ?>', '<?php echo e($mapping->passenger_type); ?>'); return false;"
                                                    >
...
<?php endif; ?>
                                                    ...
                                                    <form action="<?php echo e(route('rezgo.product-mappings.delete', $mapping->id)); ?>" method="POST" style="display: inline;">
                                                        ...
                                                        <button
                                                            ...
                                                            data-bs-toggle="tooltip"
                                                            data-bs-original-title="<?php echo e(__('Delete mapping')); ?>"
                                            ...
                                            <?php $__currentLoopData = $rezgoTours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form action="<?php echo e(route('rezgo.import-as-draft')); ?>" method="POST" style="display:inline;">
                                                            <?php echo csrf_field(); ?>
                                                            <input type="hidden" name="rezgo_uid" value="<?php echo e($tour['uid'] ?? ''); ?>">
                                                            <input type="hidden" name="rezgo_title" value="<?php echo e($tour['name'] ?? $tour['item'] ?? ''); ?>">
                                                            <button type="submit" class="btn btn-sm btn-success"><?php echo e(__('Import as Draft')); ?></button>
                                                        </form>
                                                    </td>
                                                </tr>
