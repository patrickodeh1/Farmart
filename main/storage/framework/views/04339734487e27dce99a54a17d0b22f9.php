...
<?php $component->withAttributes(['type' => 'success']); ?>
        <?php echo e(trans('plugins/fob-plugin-manager::plugin-manager.plugin_upload.installed_message', ['file' => session('fileName'), 'name' => $pluginContent['name']])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.index','data' => ['method' => 'post','url' => route('plugins.change.status')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['method' => 'post','url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('plugins.change.status'))]); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(trans('plugins/fob-plugin-manager::plugin-manager.plugin_upload.plugin_information.title')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                <?php echo e(trans('plugins/fob-plugin-manager::plugin-manager.plugin_upload.plugin_information.description')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                <?php echo e(Arr::get($pluginContent, 'description')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                <?php if(Arr::get($pluginContent, 'url')): ?>
                                    <a href="<?php echo e(Arr::get($pluginContent, 'url')); ?>" target="_blank"><?php echo e(Arr::get($pluginContent, 'author')); ?></a>
                                <?php else: ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                <?php echo e(Arr::get($pluginContent, 'version')); ?>
...
<?php $component->withAttributes(['type' => 'submit','color' => 'primary']); ?>
                        <?php echo e(trans('plugins/fob-plugin-manager::plugin-manager.plugin_upload.activate_plugin')); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/platform/plugins/fob-plugin-manager-1.0.2/resources/views/partials/installer.blade.php ENDPATH**/ ?>