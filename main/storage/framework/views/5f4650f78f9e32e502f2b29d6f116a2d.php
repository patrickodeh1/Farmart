        ...
        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            >
                <?php if($item['url'] && ! $loop->last): ?>
                    <a class="mb-0 d-inline-block fs-6 lh-1" href="<?php echo e($item['url']); ?>"><?php echo $item['label']; ?></a>
                <?php else: ?>
...
<?php /**PATH /var/www/html/platform/core/base/resources/views/breadcrumb.blade.php ENDPATH**/ ?>