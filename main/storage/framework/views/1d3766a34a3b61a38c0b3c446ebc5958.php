...
<?php $component->withAttributes(['type' => 'warning']); ?>
            <?php echo BaseHelper::clean(trans('plugins/fob-plugin-manager::plugin-manager.plugin_upload.not_enabled')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'warning']); ?>
            <?php echo BaseHelper::clean(trans('plugins/fob-plugin-manager::plugin-manager.plugin_upload.description', ['link' => Html::link('https://marketplace.botble.com/products', 'Botble Marketplace', ['target' => '_blank'])])); ?>
...
<?php endif; ?>
        ...
        <?php if(session()->has('isUpdate')): ?>
            <?php echo $__env->make('plugins/fob-plugin-manager::partials.updater', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php elseif(session()->has('isInstall')): ?>
            <?php echo $__env->make('plugins/fob-plugin-manager::partials.installer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php else: ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.index','data' => ['method' => 'post','files' => 'true','url' => route('plugin-manager.upload-plugin.store')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['method' => 'post','files' => 'true','url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('plugin-manager.upload-plugin.store'))]); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(trans('plugins/fob-plugin-manager::plugin-manager.plugin_upload.title')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.text-input','data' => ['type' => 'file','name' => 'file','wrapperClass' => 'mb-0','accept' => 'application/zip','helperText' => trans('plugins/fob-plugin-manager::plugin-manager.plugin_upload.input_file_description')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'file','name' => 'file','wrapper-class' => 'mb-0','accept' => 'application/zip','helperText' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/fob-plugin-manager::plugin-manager.plugin_upload.input_file_description'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['type' => 'submit','color' => 'primary']); ?>
                            <?php echo e(trans('plugins/fob-plugin-manager::plugin-manager.plugin_upload.upload_and_install')); ?>
...
<?php echo $__env->make(BaseHelper::getAdminMasterLayoutTemplate(), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/platform/plugins/fob-plugin-manager-1.0.2/resources/views/uploader.blade.php ENDPATH**/ ?>