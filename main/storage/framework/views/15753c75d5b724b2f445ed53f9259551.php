...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::card.index','data' => ['class' => 'mb-3','attributes' => new \Illuminate\View\ComponentAttributeBag(Arr::get($metaBox, 'attributes', []))]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mb-3','attributes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(new \Illuminate\View\ComponentAttributeBag(Arr::get($metaBox, 'attributes', [])))]); ?>
...
<?php $component->withAttributes([]); ?>
            <?php if(($subtitle = Arr::get($metaBox, 'subtitle')) && ($title = Arr::get($metaBox, 'title'))): ?>
                <div>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e($subtitle); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(Arr::get($metaBox, 'title')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal61297c2b6766060b621d6f9a17b28154)): ?>
<?php $attributes = $__attributesOriginal61297c2b6766060b621d6f9a17b28154; ?>
<?php unset($__attributesOriginal61297c2b6766060b621d6f9a17b28154); ?>
...
<?php endif; ?>
            ...
            <?php if(Arr::get($metaBox, 'header_actions')): ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                    <?php echo Arr::get($metaBox, 'header_actions'); ?>
...
<?php endif; ?>
        ...
        <?php if(!($hasTable = Arr::get($metaBox, 'has_table', false))): ?>
...
<?php endif; ?>
        ...
        <?php if(($footer = Arr::get($metaBox, 'footer'))): ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/platform/core/base/resources/views/forms/partials/meta-box.blade.php ENDPATH**/ ?>