...
<?php $component->withAttributes([]); ?>
            ...
            <?php endif; ?>
            <?php echo e($title ?? apply_filters(BASE_ACTION_FORM_ACTIONS_TITLE, trans('core/base::forms.publish'))); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
        <?php echo $__env->make('core/base::forms.partials.form-buttons', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<header
    ...
    id="form-actions"
    style="<?php echo \Illuminate\Support\Arr::toCssStyles(['display: none']) ?>"
>
    <div class="navbar">
        <div class="<?php echo e(AdminAppearance::getContainerWidth()); ?>">
            <div class="row g-2 align-items-center w-100">
                <?php if(is_in_admin(true)): ?>
                    <div class="col">
...
<?php /**PATH /var/www/html/platform/core/base/resources/views/forms/partials/form-actions.blade.php ENDPATH**/ ?>