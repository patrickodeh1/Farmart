...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::card.index','data' => ['id' => $box['id'],'class' => 'meta-boxes mb-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($box['id']),'class' => 'meta-boxes mb-3']); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php echo BaseHelper::clean($box['title']); ?>
...
<?php endif; ?>
        ...
        <?php echo $__env->yieldPushContent('meta-box-header-' . $box['id']); ?>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/platform/core/base/resources/views/elements/meta-box-wrap.blade.php ENDPATH**/ ?>