    ...
    <ol class="breadcrumb">
        <?php $__currentLoopData = $breadcrumbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $breadcrumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if($breadcrumb->url && !$loop->last): ?>
                <a class="mb-0 d-inline-block fs-6 lh-1" href="<?php echo e($breadcrumb->url); ?>"><?php echo e($breadcrumb->title); ?></a>
            <?php else: ?>
...
<?php /**PATH /var/www/html/platform/core/base/resources/views/layouts/partials/breadcrumbs.blade.php ENDPATH**/ ?>