...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                            <?php echo $__env->make('plugins/audit-log::activity-line', compact('history'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::empty-state','data' => ['title' => __('No results found'),'subtitle' => __('It looks as through there are no activities here.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /var/www/html/platform/plugins/audit-log/resources/views/widgets/activities.blade.php ENDPATH**/ ?>