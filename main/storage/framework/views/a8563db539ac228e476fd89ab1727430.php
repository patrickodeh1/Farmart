...
<?php $component->withAttributes([]); ?>
                            <?php if($post->slug): ?>
                                <a
                                    ...
                                    target="_blank"
                                ><?php echo e(Str::limit($post->name, 80)); ?></a>
                            <?php else: ?>
                                <strong><?php echo e(Str::limit($post->name, 80)); ?></strong>
                            <?php endif; ?>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal39a228eaec73c356bdf14858f816ca38)): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::empty-state','data' => ['title' => __('No results found'),'subtitle' => trans('plugins/blog::posts.no_new_post_now')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('No results found')),'subtitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/blog::posts.no_new_post_now'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /var/www/html/platform/plugins/blog/resources/views/widgets/posts.blade.php ENDPATH**/ ?>