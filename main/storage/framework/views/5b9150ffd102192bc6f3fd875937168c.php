                                            ...
                                            <td>
                                                <div class="small">
                                                    <?php $__currentLoopData = $order['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        ?>
                                                        <div>
                                                            <span class="badge bg-<?php echo e($product['mapped'] ? 'success' : 'warning'); ?> text-white">
                                                            ...
                                                            <?php if($product['mapped']): ?>
                                                                <br><small class="text-muted">
                                                                    ...
                                                                    <?php if($product['rezgo_price'] > 0): ?>
                                                                        <span class="badge bg-primary text-white ms-1">$<?php echo e(number_format($product['rezgo_price'], 2)); ?></span>
                                                                    <?php endif; ?>
                                                                    <?php if(is_numeric($availability)): ?>
                                                                        <span class="badge bg-<?php echo e($hasAvailability ? 'info' : 'danger'); ?> ms-1 text-white">
...
<?php echo $__env->make('core/base::layouts/master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/platform/plugins/rezgo-plugin/src/Providers/../../resources/views/admin/submit-order.blade.php ENDPATH**/ ?>