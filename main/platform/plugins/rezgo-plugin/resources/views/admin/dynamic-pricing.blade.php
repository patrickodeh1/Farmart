        ...
        <div class="container-xl">
            <div class="page-header d-print-none">
                <div class="row align-items-center">
                    <div class="col">
                        <h2 class="page-title">{{ __('Price Sync') }}</h2>
                    </div>
                    <div class="col-auto">
            ...
            <div class="container-xl">
                <div class="row row-cards">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('Sync Prices from Rezgo') }}</h3>
                            </div>
                            <div class="card-body">
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-6 text-end">
                                        <button type="button" class="btn btn-primary" id="syncButton" onclick="syncPrices()">
                                            ...
                                            <i class="ti ti-refresh"></i> {{ __('Sync Prices Now') }}
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 mt-3">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('Sync Results') }}</h3>
...
function syncPrices() {
    ...
    fetch('{{ route("rezgo.sync-prices-ajax") }}', {
        method: 'POST',
        headers: {
