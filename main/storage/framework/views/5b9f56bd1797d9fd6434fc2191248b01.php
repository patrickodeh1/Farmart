...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php echo e(trans('plugins/ecommerce::products.related_products')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '766be9a31b02d85b4410065d426a1ede::box-search-advanced','data' => ['type' => 'product','searchTarget' => $dataUrl,'shown' => $products->isNotEmpty()]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'product','search-target' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($dataUrl),'shown' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($products->isNotEmpty())]); ?>
            <input
                name="related_products"
                type="hidden"
                value="<?php if($products->isNotEmpty()): ?> <?php echo e(implode(',', $product->products()->allRelatedIds()->all())); ?> <?php endif; ?>"
            />
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <?php echo e(trans('plugins/ecommerce::products.cross_selling_products')); ?>
...
<?php $component->withAttributes([]); ?>
        ...
        <?php if (isset($component)) { $__componentOriginal716474f28734973ec85e923173fde136 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal716474f28734973ec85e923173fde136 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '766be9a31b02d85b4410065d426a1ede::box-search-advanced','data' => ['type' => 'product','searchTarget' => $dataUrl,'shown' => $products->isNotEmpty(),'template' => 'selected-cross-sell-product-list-template']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('plugins-ecommerce::box-search-advanced'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'product','search-target' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($dataUrl),'shown' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($products->isNotEmpty()),'template' => 'selected-cross-sell-product-list-template']); ?>
             <?php $__env->slot('items', null, []); ?> 
                <?php echo $__env->make('plugins/ecommerce::products.partials.selected-cross-sell-products', [
                    'products' => $products,
                    'includeVariation' => false,
                ], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
             <?php $__env->endSlot(); ?>
...
<?php endif; ?>
        ...
        <p class="small text-muted mt-2 mb-2">
            <strong><?php echo e(trans('plugins/ecommerce::products.cross_sell_help.price')); ?></strong>:
            <?php echo e(trans('plugins/ecommerce::products.cross_sell_help.price_description')); ?>

        </p>
        <p class="small text-muted mb-0">
            <strong><?php echo e(trans('plugins/ecommerce::products.cross_sell_help.type')); ?></strong>:
            <?php echo e(trans('plugins/ecommerce::products.cross_sell_help.type_description')); ?>
...
<?php if (isset($component)) { $__componentOriginal0e6b0152aee5342533433c1a5b9b4cb1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0e6b0152aee5342533433c1a5b9b4cb1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::custom-template','data' => ['id' => 'selected-cross-sell-product-list-template']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('core::custom-template'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'selected-cross-sell-product-list-template']); ?>
    <div class="list-group-item">
        <input
            type="hidden"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::form.text-input','data' => ['label' => trans('plugins/ecommerce::products.price'),'name' => 'cross_sale_products[__id__][price]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(trans('plugins/ecommerce::products.price')),'name' => 'cross_sale_products[__id__][price]']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php unset($__componentOriginal0e6b0152aee5342533433c1a5b9b4cb1); ?>
<?php endif; ?>
<?php /**PATH /var/www/html/platform/plugins/ecommerce/resources/views/products/partials/extras.blade.php ENDPATH**/ ?>