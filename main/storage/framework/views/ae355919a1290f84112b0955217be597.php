...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => '8def1252668913628243c4d363bee1ef::card.index','data' => ['id' => 'panel-section-'.e($groupId).'-'.e($id).'','dataPriority' => ''.e($priority).'','dataId' => ''.e($id).'','dataGroupId' => ''.e($groupId).'','class' => 'mb-4 panel-section panel-section-'.e($id).' panel-section-priority-'.e($priority).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'panel-section-'.e($groupId).'-'.e($id).'','data-priority' => ''.e($priority).'','data-id' => ''.e($id).'','data-group-id' => ''.e($groupId).'','class' => 'mb-4 panel-section panel-section-'.e($id).' panel-section-priority-'.e($priority).'']); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/platform/core/base/resources/views/sections/section.blade.php ENDPATH**/ ?>