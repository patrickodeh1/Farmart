            ...
            <div class="page-header d-print-none">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto d-flex gap-2">
                        <a href="<?php echo e(route('rezgo.submit-order.form')); ?>" class="btn btn-info"><?php echo e(__('Submit Order')); ?></a>
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $submissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge bg-<?php echo e($submission->status === 'success' ? 'success' : 'danger'); ?>">
                                                ...
                                                <td>
                                                    <?php if($submission->http_status): ?>
                                                        <span class="badge bg-<?php echo e($submission->http_status >= 200 && $submission->http_status < 300 ? 'success' : 'danger'); ?>">
